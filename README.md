...
VocabTreeImpl это реализация широко известной в области компьютерного зрения модели хранения и выборки изображений. Ее назначение состоит в том, чтобы осуществить быстрое распознование изображения-запроса среди множества хранимых изображений.
